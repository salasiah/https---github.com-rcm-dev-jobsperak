    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        <tr valign="baseline">
          ...
          <td><select name="edu_qualification" class="date">
            <?php 
do {  
?>
...
?>
        ...
        <tr valign="baseline">
          ...
          <td><select name="edu_fieldStudy" class="date">
            <?php 
do {  
?>
...
?>
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="edu_major" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Grade</td>
          <td><select name="edu_grade" class="date">
            <?php 
do {  
?>
...
?>
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="edu_cgpa" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Insititute/University</td>
          <td><input type="text" name="edu_university" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
