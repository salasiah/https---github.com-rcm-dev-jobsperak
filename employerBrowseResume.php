...
?>
  ...
  <tr>
  	<td>&nbsp;</td>
    <td><input name="submitGeneral" type="submit" value="Search"></td>
  </tr>
</table>
			</form>
        </div>
...
?>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input name="submitSPM" type="submit" value="Search"></td>
              </tr>
            </table>
		</form>
        </div>
...
?>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input name="submitEdu" type="submit" value="Search"></td>
              </tr>
            </table>
            </form>
        </div>
...
?>
          ...
          <tr>
                <td>&nbsp;</td>
                <td><input name="submitLang" type="submit" value="Search"></td>
              </tr>
        </table>
		</form>
        </div>
...
?>
                ...
                <tr>
                	<td>&nbsp;</td>
                	<td><input name="submitPrefer" type="submit" value="Search"></td>
              </tr>
            </table>
		</form>
        </div></td>
