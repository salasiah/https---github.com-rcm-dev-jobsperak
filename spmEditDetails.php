        ...
        <tr valign="baseline">
          ...
          <td><label for="spm_grade"></label>
            <select name="spm_grade" class="date" id="spm_grade">
              <option value="A+" <?php if (!(strcmp("A+", $row_rsSPMJsID['spm_grade']))) {echo "selected=\"selected\"";} ?>>A+</option>
              <option value="A" <?php if (!(strcmp("A", $row_rsSPMJsID['spm_grade']))) {echo "selected=\"selected\"";} ?>>A</option>
              <option value="A-" <?php if (!(strcmp("A-", $row_rsSPMJsID['spm_grade']))) {echo "selected=\"selected\"";} ?>>A-</option>
              <option value="B+" <?php if (!(strcmp("B+", $row_rsSPMJsID['spm_grade']))) {echo "selected=\"selected\"";} ?>>B+</option>
              <option value="B" <?php if (!(strcmp("B", $row_rsSPMJsID['spm_grade']))) {echo "selected=\"selected\"";} ?>>B</option>
<option value="C+" <?php if (!(strcmp("C+", $row_rsSPMJsID['spm_grade']))) {echo "selected=\"selected\"";} ?>>C+</option>
              <option value="C" <?php if (!(strcmp("C", $row_rsSPMJsID['spm_grade']))) {echo "selected=\"selected\"";} ?>>C</option>
              <option value="D" <?php if (!(strcmp("D", $row_rsSPMJsID['spm_grade']))) {echo "selected=\"selected\"";} ?>>D</option>
              <option value="E" <?php if (!(strcmp("E", $row_rsSPMJsID['spm_grade']))) {echo "selected=\"selected\"";} ?>>E</option>
              <option value="G" <?php if (!(strcmp("G", $row_rsSPMJsID['spm_grade']))) {echo "selected=\"selected\"";} ?>>G</option>
            </select></td>
        </tr>
        <tr valign="baseline">
