...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td>Find Lat Long Campus at <a href="http://itouchmap.com/latlong.html" target="_blank">Here</a></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Lat</td>
      <td><input type="text" name="rs_lat" value="" size="32" placeholder="1.00000" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Long</td>
      <td><input type="text" name="rs_long" value="" size="32" placeholder="1.00000" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="rs_date" value="" size="32" placeholder="Pick Date" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td><input type="submit" value="New Road Show" /></td>
    </tr>
  </table>
