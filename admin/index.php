...
if (isset($_POST['login_username'])) {
  ...
  $LoginRS__query=sprintf("SELECT admin_name, admin_password FROM jp_admin WHERE admin_name=%s AND admin_password=%s",
...
<div id="main_container">
    ...
    <div class="logo"><a href="#"><img src="images/logo.png" alt="" title="" border="0" /></a></div>
         ...
         <form action="<?php echo $loginFormAction; ?>" name="login_form" method="POST" class="niceform">
         
              <fieldset>
                    <dl>
                        <dt><label for="login_username">Username:</label></dt>
                        <dd><input type="text" name="login_username" id="login_username" size="54" /></dd>
                    </dl>
                    <dl>
                        <dt><label for="login_password">Password:</label></dt>
                        <dd><input type="password" name="login_password" id="login_password" size="54" /></dd>
                    </dl>
    ...
    <div class="footer_login">
    	...
    	<div class="left_footer_login">Pusat Kerjaya Amanjaya | <a href="http://jobsperak.com">JOBSPERAK 2012</a></div>
