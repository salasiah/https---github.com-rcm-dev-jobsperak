...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  // multiple recipients
  $to  = 'mahfudz@richcoremedia.com' . ', '; // note the comma
  $to .= 'dzairilimran@gmail.com' . ', ';
  $to .= 'ameronr@gmail.com';
  $subject = 'New Job Ad Submitted '. ucfirst($_POST['ads_title']) .' - Jobsperak Recruitment Portal';
  $message = 'Hi, There have new JobAds has been submitted Please review and publish the JobAds http://www.jobsperak.com/v1/admin/manageAds.php


  Thanks,
  Jobsperak.com Recuitment Portal Team
  webmaster@jobsperak.com';

  $headers = "Reply-To: Do not Reply <webmaster@jobsperak.com>\r\n"; 
  $headers .= "Return-Path: Do not Reply <no-reply@jobsperak.com>\r\n"; 
  $headers .= "From: Do not Reply <no-reply@jobsperak.com>\r\n";
  $headers .= "Cc: melly@peka.my, anisrashidi@gmail.com, azhanir@gmail.com";
  $headers .= "Organization: Jobsperak Portal\r\n";
