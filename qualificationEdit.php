...
<div class="master_details">
  ...
  <?php } // Show if recordset empty ?>
    ...
    <table width="700" border="0" align="center" cellpadding="4" cellspacing="0" class="csstable">
      <tr>
        <th>Qualification</th>
        <th>Major</th>
        <th>Edit</th>
    ...
    <br/>
    <a href="qualificationAdd.php?cuid=<?php echo $_SESSION['MM_UserID']; ?>">Add More Qualification</a> </div>
</div>
