    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        <tr valign="baseline">
          ...
          <td><input type="text" name="skills_name" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Year Experience</td>
          <td><input type="text" name="skills_y_exp" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Proficiency</td>
          <td><input type="text" name="skills_proficiency" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
