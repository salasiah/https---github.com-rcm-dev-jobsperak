  ...
  <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
    <table width="600" align="center">
      <tr valign="baseline">
        ...
        <td><input type="text" name="jobseeker_tel" value="" size="32"></td>
      </tr>
      <tr valign="baseline">
        <td nowrap align="right">Mobile Phone</td>
        <td><input type="text" name="jobseeker_mobile" value="" size="32"></td>
      </tr>
      <tr valign="baseline">
        <td align="right" valign="middle" nowrap>Address</td>
        <td><textarea name="jobseeker_address" cols="50" rows="5"></textarea></td>
      </tr>
      <tr valign="baseline">
...
?>
      ...
      <tr valign="baseline">
        ...
        <td><textarea name="jobseeker_moreinfo" cols="50" rows="5"></textarea></td>
      </tr>
      <tr valign="baseline">
